        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true, defaultValue: "user"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SeatNumber = table.Column<string>(type: "nvarchar(max)", nullable: true, computedColumnSql: "[Row] + CAST([SeatColumn] AS NVARCHAR(10))"),
                    SeatType = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true, defaultValue: "standard"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Showtime_EndTime", "[EndTime] > [StartTime]");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookingQrCodes", x => x.QrCodeId);
                    table.ForeignKey(
                        name: "FK_BookingQrCodes_Bookings_BookingId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookingQrCodes_BookingId",
                table: "BookingQrCodes",
                column: "BookingId",
                unique: true);
